...
For full instructions, refer to the [wiki](<https://github.com/La-ah-Tech/frappe/wiki/Using-Frappe-with-Amazon-RDS-(or-any-other-DBaaS)>). Common question can be found in Issues and on forum.
